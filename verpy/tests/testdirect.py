...
from verpy.analyzer.FunctionAnalyzer import FunctionAnalyzer
...
v = FunctionAnalyzer.parse( ( './syntaxonly/legacyver.v',
                            './syntaxonly/namediff.v',
                            '+incdir+./syntaxonly -y ./syntaxonly')
                         )
v.link()
#v.dump()
v.elaborate()
